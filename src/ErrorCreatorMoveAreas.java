...
public class ErrorCreatorMoveAreas extends GeneralProcessor
{
    ...
    public DataGrid process(DataGrid grid) 
    {
        ...
        double[] areaValues=grid.getPresenceAreaValues();
        //cellsCreated=new int[areaSizes.length];
        double[][] data=Helpers.deepArrayCopy(MappingProject.grid.getEmptyGrid());
    ...
    private void expandArea(double[][] data, int x, int y)
    {
