...
public class MappingGrid 
{
    ...
    public void reduceResolution(int reductionFactor)
    {
        ...
        ArrayList<Point2D> newWorldCoords = new ArrayList<Point2D>();
        for(int x=0; x<xCells;x++)
        {
            for(int y=0;y<yCells;y++)
            {
                ...
                {
                    Point2D coords = new Point2D(worldLeft+cellsize*x,worldTop-cellsize*y);
    ...
    public CsvTable createTableFromLayer(SpatialDataLayer layer, boolean processed)
    {
        ...
        public CsvTable createTableFromLayer(SpatialDataLayer layer, boolean processed, double cellSize)
        {
             CsvTable table = new CsvTable();
